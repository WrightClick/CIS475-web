...
<body>
    ...
    <div class="main_container">
        ...
        <div class="body">
            <br>
            <h2 class="introtext">Contact</h2>
            <h2 class="paragraph_head">Currently, the best way to contact me is to email me.</h2>
            <br>
            <p><a href="mailto:matthewc.l.wright@gmail.com">Click here to email me!</a></p>
        </div>
